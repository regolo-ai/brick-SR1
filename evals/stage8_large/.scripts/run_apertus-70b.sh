...
MODEL_ID="apertus-70b"
OUT_DIR="/root/forkGO/semantic-routing/evals/stage8_large/apertus-70b"
USAGE_LOG="/root/forkGO/semantic-routing/evals/stage8_large/apertus-70b_usage.jsonl"
LOG_FILE="/root/forkGO/semantic-routing/evals/stage8_large/apertus-70b.log"
...
if run_lm_eval 8192; then
    echo "=== DONE (max_tokens=8192): apertus-70b ==="
else
    echo "[WARN] 8192 fallito, riprovo con 4096..."
    if run_lm_eval 4096; then
        echo "=== DONE (max_tokens=4096 fallback): apertus-70b ==="
    else
        echo "[ERROR] Entrambi i tentativi falliti per apertus-70b" >&2
        exit 1
    fi
fi
