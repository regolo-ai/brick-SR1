#!/usr/bin/env bash
# run_individual_models_hard_v5.sh — Run brick_hard (200 MMLU-Pro questions) on all 6 models
# v5: max_tokens=16384 (with fallback to 8192 on API context/token errors)
set -eo pipefail
...
STAGE_DIR="${EVALS_DIR}/stage6_individual_hard_v5"
TMUX_SESSION="evals-hard-v5"
...
for model_id in "${MODELS[@]}"; do
    ...
    # Extra model_args for specific models
    extra_model_args=""
...
echo ""
echo "=== v5 evals launched (200 MMLU-Pro questions, 6 models, max_tokens=16384). Results: ${STAGE_DIR}/ ==="
