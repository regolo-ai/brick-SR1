#!/usr/bin/env bash
#
# run_individual_models_hard.sh — Run brick_hard eval on each model directly via Regolo API
#
set -eo pipefail
...
STAGE_DIR="${EVALS_DIR}/stage6_individual_hard"
TMUX_SESSION="evals-individual-hard"
