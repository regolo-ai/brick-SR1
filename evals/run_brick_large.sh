#!/usr/bin/env bash
# run_brick_large.sh — Run brick_large (2000 questions) via Brick gateway
# Launches a dedicated tmux session: large-brick
# Results → evals/stage8_large/brick/
set -eo pipefail
...
echo "[LAUNCH] Brick → tmux attach -t ${SESSION}"
