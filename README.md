...
📘 **[Read the practical Brick + Claude Code CLI guide on Regolo](https://regolo.ai/brick-claude-code-cli-guide/)** — installation, intelligent routing, and cost optimization.
...
`brick profile edit work` preserves the existing profile and reports “no changes” when you exit without modifying anything.
