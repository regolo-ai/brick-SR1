...
func TestToLegacyRegistry_IncludesAliases(t *testing.T) {
	...
	piiLoraRepo := "LLM-Spatial-Router/lora_pii_detector_bert-base-uncased_model"
	piiLoraTests := []string{
	...
	piiModernBertRepo := "llm-spatial-router/mmbert-pii-detector-merged"
	...
	intentRepo := "LLM-Spatial-Router/lora_intent_classifier_bert-base-uncased_model"
	intentTests := []string{
	...
	jailbreakRepo := "LLM-Spatial-Router/jailbreak_classifier_modernbert-base_model"
