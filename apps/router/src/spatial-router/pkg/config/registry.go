...
var DefaultModelRegistry = []ModelSpec{
	// Domain/Intent Classification
	{
		...
		RepoID:              "LLM-Spatial-Router/lora_intent_classifier_bert-base-uncased_model",
	...
	// PII Detection - BERT LoRA
	{
		...
		RepoID:              "LLM-Spatial-Router/lora_pii_detector_bert-base-uncased_model",
	...
	// PII Detection - ModernBERT (Token-level)
	{
		...
		RepoID:           "llm-spatial-router/mmbert-pii-detector-merged",
	...
	// Jailbreak Detection
	{
		...
		RepoID:              "LLM-Spatial-Router/jailbreak_classifier_modernbert-base_model",
	...
	// Hallucination Detection - Sentinel
	{
		...
		RepoID:           "LLM-Spatial-Router/halugate-sentinel",
	...
	// Feedback Detection
	{
		...
		RepoID:           "llm-spatial-router/feedback-detector",
	...
	// Embedding Models - mmBERT 2D Matryoshka (Multilingual)
	{
		...
		RepoID:           "llm-spatial-router/mmbert-embed-32k-2d-matryoshka",
	...
	// mmBERT-32K Intent Classifier
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-intent-classifier-lora",
	...
	// mmBERT-32K Fact-Check Classifier
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-factcheck-classifier-lora",
	...
	// mmBERT-32K Jailbreak Detector
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-jailbreak-detector-lora",
	...
	// mmBERT-32K Feedback Detector (LoRA)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-feedback-detector-lora",
	...
	// mmBERT-32K Feedback Detector (Merged - for Rust/Go inference)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-feedback-detector-merged",
	...
	// mmBERT-32K Intent Classifier (Merged)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-intent-classifier-merged",
	...
	// mmBERT-32K Fact-Check Classifier (Merged)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-factcheck-classifier-merged",
	...
	// mmBERT-32K Jailbreak Detector (Merged)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-jailbreak-detector-merged",
	...
	// mmBERT-32K PII Detector (Merged)
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-pii-detector-merged",
	...
	// mmBERT-32K PII Detector
	{
		...
		RepoID:           "llm-spatial-router/mmbert32k-pii-detector-lora",
