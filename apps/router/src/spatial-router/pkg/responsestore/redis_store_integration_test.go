...
import (
	...
	"github.com/regolo-ai/brick-SR1/apps/router/src/spatial-router/pkg/responseapi"
)
...
func setupRedisStore(t *testing.T) *RedisStore {
	...
	if err != nil {
		t.Skipf("Skipping Redis integration test; Redis is not available on localhost:6379: %v", err)
	}
