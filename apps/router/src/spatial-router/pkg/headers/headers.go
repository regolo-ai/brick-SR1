...
// Package headers provides constants for all custom HTTP headers used in the spatial router.
// All custom headers follow the "x-" prefix convention for non-standard HTTP headers.

// Request Headers
// These headers are used in incoming requests to the spatial router.
const (
...
// Vector Spatial Router decision-making information for debugging and monitoring.
