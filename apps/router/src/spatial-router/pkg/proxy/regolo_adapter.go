...
// adaptForRegoloAPI translates provider-specific request body fields into
// the Regolo API format.
//
// Some local OpenAI-compatible inference servers accept reasoning parameters
// via chat_template_kwargs (e.g., {"chat_template_kwargs": {"thinking": true}}).
// Regolo expects these as top-level fields (e.g., {"thinking": true}).
//
// This function:
...
func adaptForRegoloAPI(body []byte) []byte {
	...
	// Remove the provider-specific field
