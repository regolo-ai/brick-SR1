...
const CLAUDE_MODELS = [
  {
    ...
    skill_vector: [0.7, 0.66, 0.72, 0.78, 0.54, 0.76],
    cost_weight: 0.1,
    use_reasoning: false,
  },
  {
  ...
  },
  {
    ...
    skill_vector: [0.9, 0.92, 0.86, 0.93, 0.86, 0.93],
    cost_weight: 1.0,
    use_reasoning: true,
  },
  {
  ...
  },
  {
    ...
    skill_vector: [0.96, 0.94, 0.9, 0.95, 0.91, 0.96],
    cost_weight: 1.3,
    use_reasoning: true,
  },
] as const;
